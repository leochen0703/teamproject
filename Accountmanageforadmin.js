...
import './Accountmanageforadmin.css'; 

function Accountmanageforadmin() {
  ...
  useEffect(() => {
    fetch('YOUR_BACKEND_API_URL/units')
        ...
        <div>
          ...
          {menuOpen && (
            <div className="menu-items">
              <img src="cat.jpg" alt="Avatar" className="avatar"/>
...
export default Accountmanageforadmin;
