...
import './HomepageForNotAdmin.css'; 
import { Link } from 'react-router-dom';

function HomepageForNotAdmin() {
      ...
      <div>
        ...
        {menuOpen && (
          <div className="menu-items">
            ...
            <Link to="/Accountmanageforteacher" onClick={toggleMenu}>帳號管理</Link>
...
export default HomepageForNotAdmin;
